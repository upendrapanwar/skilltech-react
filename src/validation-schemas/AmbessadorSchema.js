...
export default Yup.object().shape({
    ...
    confirm_details: Yup.string().required("Confirm Details is required"),
    terms_n_condition: Yup.string().required("Terms and condition is required"),
    update_information: Yup.string().required("Update information is required"),
