...
const ReferralPerAmbassador = () => {
  ...
  const handleDownloadReport = () => {
    const formattedData = orderDataSet.map(({ Subscriber_firstname, Subscriber_lastname, referral_code, Ambassador_firstname, Ambassador_lastname, Date_of_use_of_referral_code, HVG_Subscription_status }) => [
    ...
    const csvContent = [
      ["SUBSCRIBER FIRST NAME", "SUBSCRIBER LAST NAME", "AMBASSADOR REFERRAL CODE", "AMBASSADOR FIRST NAME", "AMBASSADOR LAST NAME", "DATE OF USE OF REFERRAL", "HVG SUBSCRIPTION STATUS"],
      ...formattedData
    ]
      .map(row => row.join(","))
      .join("\n");
    ...
    saveAs(blob, "referral_per_ambassador.csv");
  };
