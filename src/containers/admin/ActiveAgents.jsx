                                    ...
                                    {agentsActive && agentsActive.map && agentsActive.map((l, k) => {
                                            return(
                                                <tr key={k}>
                                                    ...
                                                    <td><a href="#" className="inline-block px-4 py-3 text-sm font-semibold text-center text-white uppercase transition duration-200 ease-in-out bg-indigo-600 rounded-md cursor-pointer hover:bg-indigo-700" onClick={() => openModal(l.id)}>View</a><button className="btn btn-square btn-ghost" onClick={() => deleteAgent(l.id)}><TrashIcon className="w-5"/></button></td>
                                                </tr>
                                            )
                                        })
