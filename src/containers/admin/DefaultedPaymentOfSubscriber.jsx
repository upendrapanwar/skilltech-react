...
const DefaultedPaymentOfSubscriber = () => {
  ...
  const handleDownloadReport = () => {
    const formattedData = orderDataSet.map(({ Subscriber_firstname, Subscriber_lastname, payment_status }) => [
    ...
    saveAs(blob, "defaulted_payment_of_subscriber.csv");
  };
...
export default DefaultedPaymentOfSubscriber;
