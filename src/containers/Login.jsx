    ...
    const handleSubmit = (values, { resetForm }) => {
        ...
        axios.post('common/signin', values).then(response => {
            ...
            if (response.data.status) {
                ...
                if ((response.data.data.role === 'subscriber') || (response.data.data.role === 'learner')) {
                                        ...
                                        {({ values,
                                            ...
                                            <form onSubmit={handleSubmit}>
                                                <div className="form-group">
                                                    ...
                                                    <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" name="email" onChange={handleChange} onBlur={handleBlur} value={values.email} />
                                                ...
                                                <div className="checkfileds d-flex justify-content-between align-items-center mb-4">
                                                    ...
                                                    <div className="form-check">
                                                        <Link to="" className="form-check-label">Forgot Password</Link>
                                                    </div>
                                                </div>
                                                <button type="submit" className="btn btn-primary login-btn bt-size">Login <span className="arrow-btn"><img src={solarArrowUpBroken} alt="My Happy SVG" /></span></button>
                        ...
                        <div className="col-md-6 login-col">
                            ...
                            <div className="create-content">
                                <div className="content">
                                    ...
                                    <p>Join us today!</p>
                                    <button className="create-btn btn btn-warning bt-size" onClick={redirectSignup}>Create Account <span className="arrow-btn"><img src={solarArrowUpBrokenBlu} alt="My Happy SVG" /></span></button>
                                </div>
                            </div>
                        </div>
                    </div>
